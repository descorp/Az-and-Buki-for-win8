...
namespace AzandBukiW8
{
    /// <summary>
    /// Страница, на которой отображается сгруппированная коллекция элементов.
    /// </summary>
    public sealed partial class GroupedItemsPage : AzandBukiW8.Common.LayoutAwarePage
    {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            var sampleDataGroups = GroupDataSource.GetGroups((String)navigationParameter);
        ...
        void Header_Click(object sender, RoutedEventArgs e)
        {
            ...
            this.Frame.Navigate(typeof(GroupDetailPage), ((ItemGroup)group).UniqueId);
        }
        ...
        void ItemView_ItemClick(object sender, ItemClickEventArgs e)
        {
            // Переход к соответствующей странице назначения и настройка новой страницы
            // путем передачи необходимой информации в виде параметра навигации
            var itemId = ((Item)e.ClickedItem).UniqueId;
